...
| **Subtotal** | Without the open access fee | **5,896** | **100,224,000** |
| Publication | Open access fee of the journal, needed only for the open access route | 3,190 | 54,230,000 |
| **Total** | With the open access fee | **9,086** | **154,454,000** |
