...
%% Research questions, verbatim from the ecorefs README.md ("Research questions").
...
%% RQ1. Sources: README.md ("Architecture"), core-plugin/
...
%% RQ2. Sources: README.md ("Research questions", "Comparison with other persistence approaches")
